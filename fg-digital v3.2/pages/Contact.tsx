        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
               <div className="flex flex-col gap-3 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm group">
                 <div className="bg-blue-50 p-3 rounded-2xl text-blue-600 w-fit group-hover:bg-blue-600 group-hover:text-white transition-colors"><User size={20} /></div>
                 <div>
                    <h4 className="font-bold text-slate-900 text-sm uppercase tracking-wider mb-1">Consultor</h4>
                    <p className="text-slate-600 font-bold">Francesco Gentile</p>
                 </div>
               </div>
               ...
               <div className="flex flex-col gap-3 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm group">
                 <div className="bg-blue-50 p-3 rounded-2xl text-blue-600 w-fit group-hover:bg-blue-600 group-hover:text-white transition-colors"><MapPin size={20} /></div>
                 <div>
                    <h4 className="font-bold text-slate-900 text-sm uppercase tracking-wider mb-1">Ubicación</h4>
                    <p className="text-slate-600 font-bold">Murcia, España</p>
                 </div>
               </div>
            </div>
