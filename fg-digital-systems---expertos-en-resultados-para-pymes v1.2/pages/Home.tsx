      ...
      <Section className="bg-white py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 md:gap-6">
          {[
            ...
            { title: "En español", desc: "Tu mismo idioma.", icon: <UserCheck className="w-6 h-6" /> },
            { title: "Entrega rápida", desc: "En pocos días.", icon: <Clock className="w-6 h-6" /> },
            { title: "Para PYMEs", desc: "Soluciones reales.", icon: <Globe className="w-6 h-6" />, featured: true }
          ].map((item, i) => (
