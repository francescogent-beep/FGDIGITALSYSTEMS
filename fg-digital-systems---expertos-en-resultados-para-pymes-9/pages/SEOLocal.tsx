...
const SEOLocal: React.FC = () => {
  const schema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "SEO Local", "item": `${CANONICAL_DOMAIN}/seo-local` }
    ]
  };
    ...
    <main className="bg-white">
      ...
      <Section className="pb-24">
        <div className="bg-slate-900 rounded-[3rem] p-12 text-center text-white">
          ...
          <div className="mt-8">
            <Link to="/servicios-diseno-web-seo" className="text-slate-400 hover:text-white transition-colors">Ver otros servicios</Link>
          </div>
        </div>
      </Section>
    </main>
