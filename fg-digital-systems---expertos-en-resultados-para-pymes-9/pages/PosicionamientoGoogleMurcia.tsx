...
const PosicionamientoGoogleMurcia: React.FC = () => {
  ...
  return (
    <main>
      <SEO {...METADATA.posicionamientoGoogleMurcia} />
          ...
          <div className="order-1 md:order-2 bg-slate-100 p-6 md:p-12 rounded-[2rem] border border-slate-200 relative overflow-hidden group">
             ...
             <div className="space-y-4 md:space-y-6">
                <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200">
                   ...
                   <p className="text-slate-500 text-xs italic">"Vamos a posicionarte por términos genéricos globales..."</p>
                </div>
      ...
      <Section className="bg-white py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm md:text-lg">Técnica impecable para resultados duraderos.</p>
        </div>
      ...
      <Section id="packs" className="bg-slate-50 border-t border-slate-200">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-slate-600 text-sm md:text-base max-w-xl mx-auto">Selecciona el plan de crecimiento para tu negocio en Murcia.</p>
        </div>
      ...
      <Section className="bg-white py-12 md:py-20 border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto">Negocios que han multiplicado sus llamadas gracias a estar arriba.</p>
          </div>
      ...
      <Section className="bg-slate-50 py-12 md:py-24">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600">Resolvemos las dudas más frecuentes sobre el buscador en la Región.</p>
          </div>
