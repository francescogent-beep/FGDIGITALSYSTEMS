...
export const METADATA: Record<string, PageMetadata> = {
  ...
  pricing: {
    title: "Packs Diseño Web y SEO para Pymes | FG Digital Systems",
    description: "Inversión única, sin sorpresas. Packs diseñados para que recuperes tu inversión atrayendo nuevos clientes desde el primer día.",
    keywords: "packs web pyme, soluciones seo local, propuestas diseño web claras",
  ...
  "whatsapp-business-estrategia-pymes": {
    ...
    path: "/blog/whatsapp-business-estrategia-pymes",
    ogType: "article",
  ...
  "cuanto-cuesta-conseguir-clientes-online": {
    ...
    path: "/blog/cuanto-cuesta-conseguir-clientes-online",
    ogType: "article",
  ...
  "google-business-profile-guia-pro-2026": {
    ...
    path: "/blog/google-business-profile-guia-pro-2026",
    ogType: "article",
  ...
  "velocidad-web-factor-ranking-pymes": {
    ...
    path: "/blog/velocidad-web-factor-ranking-pymes",
    ogType: "article",
  ...
  "marketing-digital-bajo-presupuesto-local": {
    ...
    path: "/blog/marketing-digital-bajo-presupuesto-local",
    ogType: "article",
  ...
  "automatizacion-leads-pymes-guia": {
    ...
    path: "/blog/automatizacion-leads-pymes-guia",
    ogType: "article",
  ...
  "importancia-reseñas-seo-local": {
    ...
    path: "/blog/importancia-reseñas-seo-local",
    ogType: "article",
  ...
  "copywriting-webs-servicios-guia": {
    ...
    path: "/blog/copywriting-webs-servicios-guia",
    ogType: "article",
  ...
  disenoWebMurcia: {
    ...
    description: "Creamos tu web profesional en Murcia enfocada a captar clientes. Mobile-first, ultra-rápida y con precios cerrados. Sin cuotas.",
