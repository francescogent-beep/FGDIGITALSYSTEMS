...
export const metadata: Metadata = {
  title: METADATA.seoLocal.title,
  description: METADATA.seoLocal.description,
  alternates: {
    canonical: `${CANONICAL_DOMAIN}${METADATA.seoLocal.path}`,
  },
};
  ...
  return (
    <main className="bg-white">
      ...
      <Section className="pt-20 bg-slate-50">
        <Breadcrumbs items={[{ label: 'Servicios', path: '/servicios' }, { label: 'SEO Local' }]} />
      ...
      <Section className="bg-blue-50 py-12 md:py-24 border-y border-blue-100">
        ...
        <Link href="/web-que-vende" className="text-blue-600 font-bold hover:underline">Combina esto con una web profesional</Link>
      </Section>
      ...
      <Section className="pb-24">
        <div className="bg-slate-900 rounded-[3rem] p-12 text-center text-white">
          ...
          <div className="mt-8">
            <Link href="/servicios" className="text-slate-400 hover:text-white">Ver otros servicios</Link>
          </div>
        </div>
      </Section>
    </main>
