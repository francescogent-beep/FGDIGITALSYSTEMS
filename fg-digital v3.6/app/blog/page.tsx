...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${CANONICAL_DOMAIN}${METADATA.blog.path}`,
  },
};
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "Blog", "item": `${CANONICAL_DOMAIN}${METADATA.blog.path}` }
        ]
      },
      {
        "@type": "Blog",
        "@id": `${CANONICAL_DOMAIN}${METADATA.blog.path}/#blog`,
        "name": "Blog de Marketing y Crecimiento para Pymes",
        "description": METADATA.blog.description,
        "publisher": {
          "@type": "Organization",
        ...
        "blogPost": BLOG_POSTS.map(post => ({
          ...
          "url": `${CANONICAL_DOMAIN}/blog/${post.id}`
        }))
      }
    ]
  };
    ...
    <main>
      ...
      <Section className="pt-20 bg-slate-50">
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-slate-600 max-w-7xl mx-auto leading-relaxed">
      ...
      <Section>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {BLOG_POSTS.map((post) => (
            <article key={post.id} className="bg-white rounded-[2rem] border border-slate-200 overflow-hidden flex flex-col group hover:shadow-xl">
              <Link href={`/blog/${post.id}`} className="aspect-video relative overflow-hidden block">
                <Image 
                  src={post.image} 
                  alt={post.title} 
              ...
              <div className="p-8 flex-grow flex flex-col">
                ...
                <Link href={`/blog/${post.id}`}>
                  <h3 className="text-xl font-extrabold text-slate-900 mb-4 group-hover:text-blue-600 leading-tight tracking-tight">
                    {post.title}
                  </h3>
                </Link>
                ...
                <Link 
                  href={`/blog/${post.id}`}
                  className="inline-flex items-center gap-2 text-blue-600 font-bold hover:gap-3"
                >
      ...
      <Section className="pb-24 pt-12">
        <div className="bg-[#0B1426] rounded-[2rem] md:rounded-[3rem] p-10 md:p-20 text-center text-white shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl text-slate-400 mb-12 max-w-7xl mx-auto font-medium leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input 
                ...
                className="flex-grow px-6 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500"
                required
              />
