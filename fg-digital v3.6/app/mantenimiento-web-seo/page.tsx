...
export const metadata: Metadata = {
  title: METADATA.mantenimientoWeb.title,
  description: METADATA.mantenimientoWeb.description,
  alternates: {
    canonical: `${CANONICAL_DOMAIN}${METADATA.mantenimientoWeb.path}`,
  },
};
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Mantenimiento y Soporte" }
        ]
      },
      {
        "@type": "Service",
        "@id": `${CANONICAL_DOMAIN}${METADATA.mantenimientoWeb.path}/#service`,
        "name": "Mantenimiento Web y Soporte SEO",
        "description": METADATA.mantenimientoWeb.description,
        "provider": { "@id": `${CANONICAL_DOMAIN}/#organization` },
        "serviceType": "Web Maintenance & SEO Support"
      }
    ]
  };
  ...
  return (
    <main className="bg-white">
      ...
      <Section className="pt-20 bg-slate-50">
        <Breadcrumbs items={[{ label: 'Servicios', path: '/servicios' }, { label: 'Mantenimiento' }]} />
      ...
      <Section className="bg-slate-50 py-12 md:py-24 border-y border-slate-200">
        ...
        <Link href="/tarifas-diseno-web" className="text-blue-600 font-bold hover:underline">Ver precios de acompañamiento mensual</Link>
      </Section>
