...
export const metadata: Metadata = {
  title: METADATA.seoLocalMurcia.title,
  description: METADATA.seoLocalMurcia.description,
  alternates: {
    canonical: `${CANONICAL_DOMAIN}${METADATA.seoLocalMurcia.path}`,
  },
};

const SEOLocalMurciaPage = () => {
  const faqs = [
  ...
  return (
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(mapsSchema) }}
      />
      ...
      <Section className="pt-12 md:pt-32 pb-10 md:pb-16 text-center bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        ...
        <div className="max-w-7xl mx-auto mt-8">
          ...
          <p className="text-lg md:text-2xl text-blue-100 mb-10 md:mb-12 max-w-7xl mx-auto leading-relaxed">
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { t: "“Nadie me llama por el botón”", d: "Tu perfil no invita a la acción inmediata.", icon: <CircleAlert className="text-red-500" /> }
                ].map((p, i) => (
          ...
          <div className="order-1 md:order-2 bg-slate-100 p-6 md:p-12 rounded-[2rem] border border-slate-200 relative overflow-hidden group">
             ...
             <div className="space-y-4 md:space-y-6">
                ...
                <div className="bg-slate-900 p-6 rounded-xl shadow-2xl border border-slate-800">
                   ...
                   <p className="text-white font-bold text-base leading-tight">"Aparezco el primero cuando busquen un fontanero en Murcia."</p>
                </div>
             </div>
          </div>
        </div>
      ...
      <Section id="packs" className="bg-slate-50 border-t border-slate-200">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-slate-700 text-sm md:text-base max-w-7xl mx-auto">Selecciona cómo quieres crecer en el mapa de Murcia.</p>
        </div>
      ...
      <Section className="bg-white py-12 md:py-20 border-t border-slate-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-7xl mx-auto">El mapa de Google es la vía más corta hacia el cliente de tu zona.</p>
          </div>
...
export default SEOLocalMurciaPage;
