...
import { ShieldCheck, Zap, Search, MousePointer2, CheckCircle2, ArrowRight, Mail, Phone, Layout } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${CANONICAL_DOMAIN}${METADATA.about.path}`,
  },
};
...
const AboutPage = () => {
  const aboutSchema = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": `${CANONICAL_DOMAIN}${METADATA.about.path}/#webpage`,
        "url": `${CANONICAL_DOMAIN}${METADATA.about.path}`,
        "name": METADATA.about.title,
        "isPartOf": { "@id": `${CANONICAL_DOMAIN}/#website` },
        "breadcrumb": { "@id": `${CANONICAL_DOMAIN}${METADATA.about.path}/#breadcrumb` },
        "inLanguage": "es-ES",
        "description": METADATA.about.description
      },
      {
        "@type": "AboutPage",
        "@id": `${CANONICAL_DOMAIN}${METADATA.about.path}/#about`,
        "mainEntity": { "@id": `${CANONICAL_DOMAIN}/#organization` }
      },
      {
        "@type": "BreadcrumbList",
        "@id": `${CANONICAL_DOMAIN}${METADATA.about.path}/#breadcrumb`,
        "itemListElement": [
      ...
      },
      {
        ...
        "jobTitle": "Fundador y Consultor Digital",
        "worksFor": { "@id": `${CANONICAL_DOMAIN}/#organization` },
        "url": `${CANONICAL_DOMAIN}${METADATA.about.path}`,
        "image": "https://i.imgur.com/ILoCkO3.png",
        "description": "Fundador de FG Digital Systems, experto en diseño web y captación de clientes para negocios locales.",
        "knowsAbout": ["SEO Local", "Diseño Web", "Marketing Digital", "Automatización de Ventas"],
        "sameAs": ["https://www.linkedin.com/in/francescogentile/"]
      },
      {
        "@type": "Organization",
        "@id": `${CANONICAL_DOMAIN}/#organization`,
        "founder": { "@id": `${CANONICAL_DOMAIN}/#founder` },
        "foundingDate": "2024",
  ...
  return (
    <main className="bg-white">
      ...
      <Section className="pt-8 md:pt-16 bg-white pb-12 md:pb-20">
        <Breadcrumbs items={[{ label: 'Sobre Nosotros' }]} />
        <h1 className="text-5xl md:text-8xl font-bold text-slate-800 leading-[1.05] mb-10 md:mb-12 tracking-tightest">
          Sobre FG Digital Systems
        </h1>
        <div className="space-y-6 md:space-y-10 text-xl md:text-3xl text-slate-500 leading-relaxed font-medium">
          <p className="text-slate-800 font-bold tracking-tight">Una web bonita no es el objetivo. El objetivo es que te traiga clientes.</p>
          <p>
          ...
          <p className="text-blue-500 font-bold tracking-tight">Y eso es exactamente lo que construimos.</p>
        </div>
      </Section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-20 items-center">
          <div className="lg:col-span-5 order-2 lg:order-1">
            <div className="relative max-w-sm mx-auto lg:max-w-none">
              <div className="aspect-[4/5] md:aspect-[3/4] rounded-[2rem] md:rounded-[2.5rem] overflow-hidden shadow-2xl border-4 md:border-8 border-white relative">
                <Image 
                  src="https://i.imgur.com/ILoCkO3.png" 
                  alt="Francesco Gentile, fundador de FG Digital Systems" 
              ...
              <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 bg-slate-900 text-white p-5 md:p-8 rounded-2xl md:rounded-3xl shadow-xl">
                ...
                <p className="text-xl md:text-2xl font-black">Francesco Gentile</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-6 md:space-y-8">
            ...
            <div className="space-y-5 text-slate-600 text-base md:text-xl leading-relaxed">
              <p>
                Soy Francesco Gentile, fundador de FG Digital Systems. Durante años trabajé en proyectos digitales, marketing y crecimiento. Y siempre veía el mismo patrón:
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { t: "Web profesional", d: "Rápida, móvil, clara.", icon: <Layout className="text-blue-600" size={20} aria-hidden="true" /> },
                { t: "SEO bien hecho", d: "Para que Google la entienda e indexe.", icon: <Search className="text-blue-600" size={20} aria-hidden="true" /> },
                { t: "Conversión", d: "WhatsApp, formularios, reservas.", icon: <MousePointer2 className="text-blue-600" size={20} aria-hidden="true" /> },
                { t: "Automatización", d: "Menos caos, más control.", icon: <Zap className="text-blue-600" size={20} aria-hidden="true" /> }
              ].map((service, i) => (
      ...
      <Section className="bg-slate-50 border-y border-slate-100 py-12 md:py-24">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-slate-600 max-w-7xl mx-auto text-lg md:text-xl font-medium">Un proceso enfocado en la claridad y la velocidad.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          {[
            ...
            <div key={i} className="space-y-5 p-6 md:p-8 bg-white border border-slate-200 rounded-2xl md:rounded-3xl shadow-sm hover:shadow-md">
      ...
      <Section className="pb-16 md:pb-24 pt-6 md:pt-12 text-center bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto bg-slate-900 text-white p-8 md:p-20 rounded-[2.5rem] md:rounded-[4rem] shadow-2xl relative overflow-hidden">
          ...
          <p className="text-base md:text-xl text-slate-400 mb-8 md:mb-10 max-w-7xl mx-auto font-medium leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-10 text-slate-300">
            <a href="tel:+34694285438" className="flex items-center gap-2 hover:text-blue-400">
              <Phone size={18} aria-hidden="true" /> +34 694 28 54 38
            </a>
            <a href="mailto:info@fgdigitalsystems.com" className="flex items-center gap-2 hover:text-blue-400">
              <Mail size={18} aria-hidden="true" /> info@fgdigitalsystems.com
            </a>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            ...
            <Button to="/tarifas-diseno-web" variant="outline" className="px-10 py-4 md:px-12 md:py-5 border-white !text-white hover:bg-white/10 hover:!text-white text-base md:text-lg w-full sm:w-auto">
              Ver Paquetes
            </Button>
          </div>
        </div>
