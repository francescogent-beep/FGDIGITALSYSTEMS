      ...
      <Section className="pt-12 md:pt-32 pb-10 md:pb-16 text-center bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-10 md:mt-12 text-slate-400 text-xs font-bold uppercase tracking-widest flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
            <span className="flex items-center gap-2"><CircleCheck size={16} className="text-green-500" /> Pago único</span>
            <span className="flex items-center gap-2"><CircleCheck size={16} className="text-green-500" /> Propiedad 100% tuya</span>
            <span className="flex items-center gap-2"><CircleCheck size={16} className="text-green-500" /> Sin permanencias</span>
          </div>
        </div>
      </Section>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { t: "“Dependo solo del boca a boca”", d: "Si no te recomiendan hoy, no facturas mañana.", icon: <CircleAlert className="text-red-500" /> },
