...
const ServiceSection: React.FC<{
  ...
  bgColor?: string;
}> = ({ id, icon, title, description, expectedResult, includes, bgColor = "bg-white" }) => (
  <Section id={id} className={`${bgColor} border-b border-slate-50 py-12 md:py-24`}>
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
      <div className="lg:sticky lg:top-24">
        ...
        {/* Expected Result Box (Dark) */}
        <div className="bg-[#0B1426] text-white p-6 rounded-2xl border-l-4 border-blue-600 shadow-xl mb-8">
          <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-400 mb-2">Resultado esperado</h4>
      ...
      <Section className="py-20 text-center bg-white">
        <div className="max-w-3xl mx-auto bg-slate-900 text-white p-12 md:p-20 rounded-[3rem] shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button to="/contacto" variant="secondary" className="px-12 py-4 text-blue-600 font-black">Hablar con un experto</Button>
            <Button to="/precios" variant="outline" className="px-12 py-4 border-white/20 text-white hover:bg-white/10">Ver Tarifas Públicas</Button>
          </div>
        </div>
      </Section>
    </main>
