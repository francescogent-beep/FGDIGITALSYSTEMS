...
export const CookieBanner: React.FC = () => {
  ...
  return (
    <div 
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-2rem)] max-w-7xl p-5 md:p-6 bg-slate-800/80 backdrop-blur-xl rounded-[1.5rem] text-white shadow-2xl border border-white/10"
    >
