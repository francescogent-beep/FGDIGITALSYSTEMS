        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          <div className="lg:col-span-5 space-y-8">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight">
              Myriam Gentile (Pedagogista): Posicionamiento SEO local estratégico
            </h2>
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed text-lg">
              <div>
                ...
                <p className="text-white">Paolo Amoruso (Atleta IFBB Pro y Coach) contaba con una marca personal potente pero carecía de un sistema de ventas estructurado. La gestión era manual, sin funnels automatizados ni ofertas escalables.</p>
              </div>
