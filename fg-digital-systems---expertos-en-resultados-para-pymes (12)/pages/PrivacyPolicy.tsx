      ...
      <Section className="py-12 md:py-24">
        <div className="max-w-3xl prose prose-slate prose-lg lg:prose-xl prose-headings:font-black prose-headings:text-slate-900 prose-strong:text-slate-900">
          ...
          <p>
            ...
            Email: <a href="mailto:contacto@fgdigitalsystems.com">contacto@fgdigitalsystems.com</a>
          </p>
          ...
          <p>Para ejercer estos derechos, puede escribir a: 📧 <a href="mailto:contacto@fgdigitalsystems.com">contacto@fgdigitalsystems.com</a></p>
