...
const Home: React.FC = () => {
  ...
  return (
    <main>
      ...
      {/* 1. HERO - IDÉNTICO AL SHELL PARA EVITAR CLS */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
            <div className="space-y-8">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  <div key={i} className="flex gap-4 p-6 bg-white border border-slate-200 rounded-2xl shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-800 font-medium">{p.d}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-blue-600 rounded-[2.5rem] md:rounded-[3.5rem] p-10 md:p-16 text-white shadow-2xl relative flex flex-col justify-center">
              <div className="mb-10">
                <span className="text-white font-black uppercase tracking-widest text-[10px] mb-2 block opacity-90">Nuestra solución</span>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-6 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blue-50 text-base leading-relaxed font-semibold opacity-100">{s.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      {/* 5. IMAGE STRATEGY - REDUCCIÓN AGRESIVA DE PESO */}
      <Section className="bg-white py-16 md:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            {/* OPTIMIZACIÓN LCP EXTREMA: w=640 y q=60 para móviles */}
            <img 
              src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?fm=webp&fit=crop&q=60&w=640" 
          ...
          <div className="space-y-8">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 leading-tight tracking-tighter">Por qué necesitas un sistema, no solo una web</h2>
      ...
      <Section className="py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-4xl mx-auto bg-slate-900 text-white p-10 md:p-24 rounded-[4rem] shadow-2xl relative overflow-hidden text-center border border-slate-800">
          <div className="absolute top-0 left-0 w-full h-2 bg-blue-600"></div>
          <h2 className="text-3xl md:text-6xl font-black mb-8 leading-tight tracking-tighter">¿Hablamos de cómo <br/> traer más clientes?</h2>
          <p className="text-slate-300 text-lg md:text-xl mb-12 max-w-lg mx-auto font-bold leading-relaxed">
