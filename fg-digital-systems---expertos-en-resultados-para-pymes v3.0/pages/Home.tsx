...
const Home: React.FC = () => {
  ...
  return (
    <main>
      ...
      {/* 1. HERO - Optimización de PT y LCP */}
      <section className="bg-white pt-6 md:pt-12 pb-12 md:pb-24 border-b border-slate-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 text-blue-900 rounded-full text-xs md:text-sm font-bold mb-6 border border-blue-100">
          ...
          <p className="text-lg md:text-2xl text-slate-700 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
           Creamos sistemas web pensados para que tu <strong>teléfono suene y entren contactos reales</strong>. Sin palabrería técnica ni cuotas mensuales.
          </p>
          ...
          <div className="mt-12 text-slate-800 text-[10px] md:text-xs font-black uppercase tracking-widest flex flex-wrap items-center justify-center gap-x-6 gap-y-4">
            <span className="flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100 shadow-sm"><CircleCheck size={14} className="text-green-700" /> Pago único</span>
            <span className="flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100 shadow-sm"><CircleCheck size={14} className="text-green-700" /> Propiedad tuya</span>
            <span className="flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100 shadow-sm"><CircleCheck size={14} className="text-green-700" /> Sin permanencias</span>
          </div>
        </div>
      </section>

      {/* 2. PROBLEMS & SOLUTIONS - Fix Contraste Accesibilidad */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-stretch">
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { t: "“No aparezco en Google”", d: "Tus vecinos encuentran a tu competencia antes.", icon: <Search className="text-red-700" /> },
                  { t: "“Dependo solo del boca a boca”", d: "Si no te recomiendan hoy, no facturas mañana.", icon: <CircleAlert className="text-red-800" /> },
                  { t: "“Recibo mensajes de curiosos”", d: "Contactos que no compran y te hacen perder tiempo.", icon: <MousePointerClick className="text-red-800" /> }
                ].map((p, i) => (
            ...
            <div className="bg-blue-600 rounded-[2rem] md:rounded-[3.5rem] p-8 md:p-14 text-white shadow-2xl relative flex flex-col justify-center">
              <div className="mb-10">
                {/* FIX CONTRASTE: Usamos text-white para máxima accesibilidad */}
                <span className="text-white font-black uppercase tracking-widest text-[10px] mb-2 block opacity-80">Nuestra solución</span>
                <h2 className="text-3xl md:text-4xl font-extrabold leading-tight text-white">Así convertimos tu web en una máquina de contactos</h2>
              </div>
              <div className="space-y-8 md:space-y-10">
                {[
                  ...
                  <div key={i} className="flex gap-5 md:gap-6 group">
                    {/* FIX CONTRASTE: Fondo más oscuro blue-950 para el número */}
                    ...
                    <div>
                      ...
                      {/* FIX CONTRASTE: Texto blue-50 para mejor lectura */}
                      <p className="text-blue-50 text-sm md:text-base leading-relaxed opacity-100 font-medium">{s.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="order-1 lg:order-2 bg-slate-100 p-8 md:p-16 rounded-[3rem] border border-slate-200 shadow-sm">
             <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                   ...
                   <p className="text-slate-800 text-sm italic font-medium">"Te entregaremos un informe de 50 páginas sobre la psicología del color en tu logo..."</p>
                </div>
      ...
      <Section id="packs" className="bg-slate-50 border-y border-slate-200 py-16 md:py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-700 text-lg max-w-xl mx-auto font-medium">Selecciona el pack que mejor encaja con tu negocio actual.</p>
        </div>
      ...
      {/* 5. IMAGE STRATEGY - Optimización LCP Extrema */}
      <Section className="bg-white py-16 md:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            {/* FIX LCP: Ajustamos el ancho a 800px para carga más rápida en móvil y fetchPriority alto */}
            <img 
              ...
              className="rounded-[3rem] shadow-2xl border-8 border-slate-50 w-full h-auto"
              width="800"
              height="500"
              loading="eager"
              fetchPriority="high"
            ...
            <div className="absolute -bottom-8 -right-8 bg-blue-600 text-white p-8 rounded-3xl shadow-2xl hidden md:block">
              ...
              <p className="text-[10px] font-bold uppercase tracking-widest opacity-90">Google Performance</p>
            </div>
          </div>
