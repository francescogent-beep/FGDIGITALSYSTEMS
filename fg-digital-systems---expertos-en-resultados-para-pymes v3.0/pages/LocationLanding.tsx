...
const LocationLanding: React.FC<LocationLandingProps> = ({ type }) => {
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      {/* 1. Hero */}
      <section className="hero-section pt-12 md:pt-32 pb-16 text-center bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="lcp-title" dangerouslySetInnerHTML={{ __html: current.h1 }} />
          ...
          <div className="mt-10 md:mt-12 text-slate-500 text-xs font-bold uppercase tracking-widest flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
            ...
            <span className="flex items-center gap-2"><CircleCheck size={16} className="text-green-600" /> Sin cuotas mensuales</span>
            <span className="flex items-center gap-2"><CircleCheck size={16} className="text-green-600" /> Propiedad tuya</span>
          </div>
        </div>
      </section>
