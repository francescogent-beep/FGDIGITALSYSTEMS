...
export const metadata: Metadata = {
  title: METADATA.posicionamientoGoogleMurcia.title,
  description: METADATA.posicionamientoGoogleMurcia.description,
  alternates: {
    canonical: `${CANONICAL_DOMAIN}${METADATA.posicionamientoGoogleMurcia.path}`,
  },
};

const PosicionamientoGoogleMurciaPage = () => {
  const faqs = [
  ...
  return (
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(positioningSchema) }}
      />
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { t: "“Mi competencia se lleva mis clientes”", d: "Ellos están ahí cuando el murciano busca tus servicios.", icon: <Search className="text-red-500" /> },
...
export default PosicionamientoGoogleMurciaPage;
