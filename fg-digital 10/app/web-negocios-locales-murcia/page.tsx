...
export const metadata: Metadata = {
  title: METADATA.webNegociosLocalesMurcia.title,
  description: METADATA.webNegociosLocalesMurcia.description,
  alternates: {
    canonical: `${CANONICAL_DOMAIN}${METADATA.webNegociosLocalesMurcia.path}`,
  },
};

const WebNegociosLocalesMurciaPage = () => {
  const faqs = [
  ...
  return (
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(salesSystemSchema) }}
      />
...
export default WebNegociosLocalesMurciaPage;
