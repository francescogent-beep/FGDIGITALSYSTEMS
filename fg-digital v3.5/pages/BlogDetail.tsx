          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <aside className="lg:col-span-3 space-y-12">
              <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-2xl">
                ...
                <div className="space-y-4">
                  <Link to="/servicios-diseno-web-seo" className="flex items-center justify-between p-4 bg-white/5 rounded-xl hover:bg-white/10 border border-white/10 group">
                    <span className="font-bold text-sm">Ver Servicios</span>
                    <ArrowRight size={16} aria-hidden="true" />
                  </Link>
                  <Link to="/tarifas-diseno-web" className="flex items-center justify-between p-4 bg-white/5 rounded-xl hover:bg-white/10 border border-white/10 group">
