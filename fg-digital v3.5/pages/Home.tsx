...
const Home: React.FC = () => {
  ...
  return (
    <main>
      ...
      {/* 1. HERO */}
      <section className="relative pt-16 md:pt-32 pb-20 md:pb-32 px-4 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-white/85 backdrop-blur-[3px]"></div>
        </div>
        ...
        >
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 text-blue-700 rounded-full text-[13px] font-bold mb-8 border border-blue-100 shadow-sm"
          >
            <Star size={14} className="fill-current" />
            Trato humano y resultados reales
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-8xl font-black text-slate-800 leading-[1.02] mb-8 tracking-tightest"
          >
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-slate-500 mb-12 md:mb-16 max-w-2xl mx-auto leading-relaxed font-medium"
          >
          ...
          <motion.div 
            ...
            className="mt-16 md:mt-24 text-slate-400 text-[11px] font-bold uppercase tracking-widest flex flex-wrap items-center justify-center gap-x-10 gap-y-4"
          >
              ...
              <div className="grid gap-5">
                {[
                  ...
                  <motion.div 
                    ...
                    className="flex gap-5 p-6 md:p-8 bg-white border border-slate-100 rounded-[2rem] shadow-sm group hover:border-blue-500/20 transition-all duration-300"
                  >
                    <div className="bg-slate-50 p-3 rounded-2xl h-fit group-hover:bg-blue-50 group-hover:text-blue-500 transition-colors">{p.icon}</div>
                    <div>
            ...
            >
              ...
              <div className="space-y-10 md:space-y-12">
                {[
                  ...
                  >
                    <div className="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/5 flex items-center justify-center font-bold text-blue-400 text-xl md:text-2xl border border-white/10 group-hover:bg-blue-500 group-hover:text-white group-hover:border-blue-500 transition-all duration-300">
                      {s.step}
                    </div>
                    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="order-1 md:order-2 bg-slate-100 p-8 md:p-16 rounded-[3rem] border border-slate-200 relative overflow-hidden group">
             ...
             <div className="space-y-8">
                ...
                <div className="bg-slate-800 p-10 rounded-2xl shadow-2xl border border-white/5 transform md:translate-x-8 scale-105">
                   <div className="flex items-center gap-3 mb-2">
      ...
      <Section className="bg-white py-16 md:py-32 overflow-hidden">
        ...
        <div className="relative group max-w-6xl mx-auto px-4">
          ...
          <div className="absolute top-1/2 -left-4 md:-left-12 -translate-y-1/2 z-10 hidden md:block">
            <button 
              onClick={() => scroll('left')}
              className="p-4 bg-white border border-slate-200 rounded-full shadow-lg text-slate-500 hover:text-blue-600 hover:border-blue-600 transition-all active:scale-90"
              aria-label="Anterior"
            >
              <ChevronLeft size={28} />
            </button>
          ...
          >
            {REVIEWS.map((review, i) => (
              <a 
                ...
                className="flex-shrink-0 w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] snap-start p-10 rounded-[2.5rem] bg-slate-50 border border-slate-100 flex flex-col hover:shadow-2xl transition-all duration-500 group hover:-translate-y-1 relative"
              >
        ...
        <div className="mt-12 text-center space-y-8">
          <div className="flex justify-center">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-slate-600 font-bold hover:text-blue-600 transition-colors py-2 px-4 rounded-xl border border-slate-200 hover:border-blue-600 bg-white shadow-sm"
            >
      ...
      <Section className="py-24 md:py-40 text-center bg-white px-4 md:px-8">
        <div className="max-w-5xl mx-auto bg-slate-800 text-white p-12 md:p-32 rounded-[3.5rem] shadow-2xl relative overflow-hidden group">
          ...
          <p className="text-slate-400 text-xl md:text-2xl mb-16 max-w-xl mx-auto leading-relaxed relative z-10 font-medium">
