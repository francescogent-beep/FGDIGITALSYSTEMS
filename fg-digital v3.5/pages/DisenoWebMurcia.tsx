    ...
    <main>
      ...
      <Section className="pt-16 md:pt-32 pb-20 md:pb-32 text-center bg-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto mt-12">
          ...
          <p className="text-xl md:text-2xl text-slate-500 mb-12 md:mb-16 max-w-2xl mx-auto leading-relaxed font-medium">
              ...
              <div className="grid gap-5">
                {[
                  ...
                  { t: "“Es bonita, pero nadie llama”", d: "Le falta estructura de venta y llamadas a la acción.", icon: <CircleAlert className="text-slate-400" /> }
                   ...
                   <div key={i} className="flex gap-5 p-6 md:p-8 bg-white border border-slate-100 rounded-[2rem] shadow-sm group hover:border-blue-500/20 transition-all duration-300">
