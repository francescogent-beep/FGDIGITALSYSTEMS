  ...
  <div className="relative group">
    ...
    <div className="relative aspect-[16/10] overflow-hidden border-x border-b border-slate-200 rounded-b-3xl bg-slate-100 shadow-2xl">
      <div className="w-full h-full overflow-hidden">
        <img 
          ...
          className="w-full h-auto object-top transition-transform duration-[6000ms] ease-in-out group-hover:translate-y-[-70%]"
          loading="lazy"
        />
      </div>
      {/* Overlay on hover */}
      <div className="absolute inset-0 bg-blue-600/0 group-hover:bg-blue-600/5 transition-colors pointer-events-none flex items-center justify-center">
         <div className="bg-white/95 backdrop-blur text-blue-600 px-4 py-2 rounded-full font-black text-[10px] uppercase tracking-widest shadow-2xl scale-0 group-hover:scale-100 transition-all duration-300 flex items-center gap-2 border border-blue-100">
    ...
    <div className="absolute -bottom-10 -right-4 w-32 md:w-44 aspect-[9/19] bg-slate-900 rounded-[2rem] md:rounded-[3rem] border-4 border-slate-800 shadow-[0_20px_50px_rgba(0,0,0,0.4)] p-1.5 overflow-hidden hidden sm:block z-20">
       <div className="w-full h-full rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden bg-black relative pt-4 md:pt-5">
          ...
          />
          {/* Dynamic island area */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-16 h-4 bg-black rounded-b-xl flex justify-center items-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
            <div className={`lg:col-span-6 space-y-8 ${index % 2 !== 0 ? 'lg:order-2' : ''}`}>
              ...
              <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                ...
                >
                  Visitar proyecto en vivo <ExternalLink size={16} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                </a>
              </div>
            </div>
            ...
            <div className={`lg:col-span-6 ${index % 2 !== 0 ? 'lg:order-1' : ''}`}>
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-2xl overflow-hidden p-8 md:p-10 relative z-10 mt-6 lg:mt-0">
                ...
                <div className="p-5 bg-blue-50/50 rounded-2xl border border-blue-100 flex items-center justify-between group">
                  ...
                  <CheckCircle2 className="text-blue-600 opacity-20 group-hover:opacity-100 transition-opacity" size={24} />
                </div>
              </div>
            </div>
          </div>
