...
import { ShieldCheck, Zap, TrendingUp, Search, MessageCircle, Layout, MousePointer2, CheckCircle2, PhoneCall, ArrowRight, Mail, Phone } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  return (
    <main className="bg-white">
      <SEO {...METADATA.about} schema={aboutSchema} />
