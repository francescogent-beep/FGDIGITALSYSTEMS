    ...
    <main className="bg-white">
      ...
      <Section className="pb-16 md:pb-24 pt-6 md:pt-12 text-center bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto bg-slate-900 text-white p-8 md:p-20 rounded-[2.5rem] md:rounded-[4rem] shadow-2xl relative overflow-hidden">
          ...
          <p className="text-base md:text-xl text-slate-400 mb-8 md:mb-10 max-w-2xl mx-auto font-medium leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-10 text-slate-300">
            <a href="tel:+34694285438" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
              <Phone size={18} aria-hidden="true" /> +34 694 28 54 38
            </a>
            <a href="mailto:info@fgdigitalsystems.com" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
