    ...
    <main className="bg-white">
      ...
      <Section className="bg-slate-50 py-12 md:py-24 border-y border-slate-200">
        ...
        <p className="text-lg text-slate-600 max-w-7xl leading-relaxed mb-10">
          Obtendrás una herramienta de negocio estable y profesional. No prometemos "ser virales", prometemos un sistema que transmita la seriedad de tu empresa y facilite que las personas interesadas en tus servicios darán el primer paso para contactarte.
        </p>
      ...
      <Section className="pb-24">
        <div className="bg-slate-900 rounded-[3rem] p-12 text-center text-white">
          ...
          <div className="mt-8">
            <Link to="/servicios-diseno-web-seo" className="text-slate-400 hover:text-white">Volver a todos los servicios</Link>
          </div>
        </div>
      </Section>
    </main>
