    ...
    <main>
      ...
      <Section className="bg-slate-50 border-y border-slate-200/50 py-16 md:py-24">
        <div className="text-center mb-16">
          <p className="text-sm md:text-lg text-slate-500 font-medium italic max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-5xl mx-auto mb-24">
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-slate-800 rounded-[3rem] p-10 md:p-20 text-white border border-white/5 shadow-2xl relative overflow-hidden"
          >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 mb-12">
              <div>
                ...
                <p className="text-slate-400 mt-4 max-w-md text-lg font-medium">{PRICING_PLANS[3].description}</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
           {RETAINERS.map((plan, i) => (
             <motion.div 
               ...
               className={`p-8 md:p-10 rounded-[2.5rem] bg-white border ${plan.recommended ? 'border-blue-600 shadow-xl lg:scale-105 z-10' : 'border-slate-200 shadow-sm'} relative flex flex-col`}
             >
                {plan.recommended && (
