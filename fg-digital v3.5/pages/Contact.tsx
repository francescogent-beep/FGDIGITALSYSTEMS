...
import { MessageCircle, ShieldCheck, Clock, HelpCircle, ArrowRight, Zap, Send, Mail, Phone, MapPin, User } from 'lucide-react';
      ...
      <Section className="pt-12 md:pt-24 pb-16 md:pb-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-24">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
               <div className="flex flex-col gap-4 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm group">
                 <div className="bg-slate-50 p-3 rounded-2xl text-blue-500 w-fit group-hover:bg-blue-500 group-hover:text-white transition-colors shadow-sm"><User size={20} /></div>
                 <div>
               ...
               <a href="tel:+34694285438" className="flex flex-col gap-4 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:border-blue-500 hover:shadow-md transition-all group">
                 <div className="bg-slate-50 p-3 rounded-2xl text-blue-500 w-fit group-hover:bg-blue-500 group-hover:text-white transition-colors shadow-sm"><Phone size={20} /></div>
                 <div>
               ...
               <a href="mailto:info@fgdigitalsystems.com" className="flex flex-col gap-4 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:border-blue-500 hover:shadow-md transition-all group">
                 <div className="bg-blue-50 p-3 rounded-2xl text-blue-500 w-fit group-hover:bg-blue-500 group-hover:text-white transition-colors shadow-sm"><Mail size={20} /></div>
                 <div>
               ...
               <div className="flex flex-col gap-4 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm group">
                 <div className="bg-slate-50 p-3 rounded-2xl text-blue-500 w-fit group-hover:bg-blue-500 group-hover:text-white transition-colors shadow-sm"><MapPin size={20} /></div>
                 <div>
            ...
            <div className="bg-slate-800 p-10 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden">
               ...
               <a 
                ...
                className="inline-flex items-center gap-2 bg-green-500 text-white px-10 py-4 rounded-full font-bold hover:bg-green-600 transition-all shadow-lg shadow-green-500/20 active:scale-95 relative z-10"
               >
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            className="bg-white p-10 md:p-20 rounded-[3.5rem] shadow-2xl border border-slate-100 flex flex-col items-center justify-center text-center"
          >
            ...
            <p className="text-slate-500 mb-12 max-w-sm mx-auto leading-relaxed text-lg font-medium">
