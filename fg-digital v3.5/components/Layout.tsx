        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center space-x-10">
            {ROUTES.map((route) => (
              ...
              >
                {route.name}
                <span className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 group-hover:w-full ${location.pathname === route.path ? 'w-full' : ''}`}></span>
              </Link>
            ))}
            <Button
              tallyId="q4GKJO"
    ...
    <footer className="bg-slate-50 text-slate-600 py-16 md:py-24 px-4 border-t border-slate-200">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/servicios-diseno-web-seo" className="hover:text-blue-500 font-semibold text-slate-700">Todos los Servicios</Link></li>
            <li><Link to="/web-que-vende" className="hover:text-blue-500 font-medium">Web que Vende</Link></li>
            <li><Link to="/seo-local" className="hover:text-blue-500 font-medium">SEO Local</Link></li>
            <li><Link to="/captacion-de-clientes" className="hover:text-blue-500 font-medium">Captación Leads</Link></li>
            <li><Link to="/mantenimiento-web-seo" className="hover:text-blue-500 font-medium">Mantenimiento</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/" className="hover:text-blue-500 font-medium">Inicio</Link></li>
            <li><Link to="/sobre-nosotros" className="hover:text-blue-500 font-medium">Sobre Nosotros</Link></li>
            <li><Link to="/tarifas-diseno-web" className="hover:text-blue-500 font-medium">Packs y Soluciones</Link></li>
            <li><Link to="/casos-exito" className="hover:text-blue-500 font-medium">Casos de Éxito</Link></li>
            <li><Link to="/blog-marketing-digital" className="hover:text-blue-500 font-medium">Blog y Guías</Link></li>
            <li><Link to="/preguntas-frecuentes" className="hover:text-blue-500 font-medium">FAQ</Link></li>
            <li><Link to="/contacto" className="hover:text-blue-500 font-medium">Contacto</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-slate-200 text-xs flex flex-col md:flex-row justify-between items-center gap-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link to="/aviso-legal" className="hover:text-slate-800 font-semibold text-slate-500">Aviso Legal</Link>
          <Link to="/politica-de-privacidad" className="hover:text-slate-800 font-semibold text-slate-500">Privacidad</Link>
          <Link to="/politica-de-cookies" className="hover:text-slate-800 font-semibold text-slate-500">Cookies</Link>
        </div>
      </div>
