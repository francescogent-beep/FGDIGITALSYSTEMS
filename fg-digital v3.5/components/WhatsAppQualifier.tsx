    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          className="relative bg-slate-900 text-white p-4 md:px-6 md:py-4 rounded-full shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center gap-2 group border border-white/10"
      ...
      {/* Modern Modal System */}
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-md transition-all duration-500">
