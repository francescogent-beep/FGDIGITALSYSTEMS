    ...
    <main>
      ...
      <Section id="packs" className="bg-slate-50 border-t border-slate-200">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-slate-700 text-sm md:text-base max-w-xl mx-auto">Selecciona el plan de crecimiento para tu negocio en Murcia.</p>
        </div>
      ...
      <Section className="bg-white py-12 md:py-20 border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">Negocios que han multiplicado sus llamadas gracias a estar arriba.</p>
          </div>
