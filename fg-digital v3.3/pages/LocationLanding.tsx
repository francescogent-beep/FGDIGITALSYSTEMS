      ...
      <Section className="bg-slate-50 py-12 md:py-24 overflow-hidden border-y border-slate-100">
        <div className="text-center mb-16 px-4">
          <div className="flex items-center justify-center gap-2 mb-3">
             ...
             <span className="text-blue-600 font-black uppercase tracking-widest text-xs block">Experiencias en Google</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4">Cerca de {cityName}</h2>
          <p className="text-slate-600 max-w-2xl mx-auto font-medium">Lo que opinan otros profesionales que ya han confiado en nosotros.</p>
        </div>
