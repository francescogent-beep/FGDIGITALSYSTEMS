    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="pt-10 md:pt-20 pb-16 md:pb-24 px-4 text-center bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-slate-700 mb-10 md:mb-12 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150">
            {current.sub}
          </p>
          ...
          <div className="mt-12 md:mt-16 text-slate-600 text-xs font-bold uppercase tracking-widest flex flex-wrap items-center justify-center gap-x-8 gap-y-4 animate-in fade-in duration-1000 delay-500">
      ...
      <Section id="packs" className="py-12 md:py-24 bg-white">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 max-w-xl mx-auto font-medium">Selecciona el pack que mejor encaja con tus objetivos actuales.</p>
        </div>
      ...
      <Section className="bg-slate-50 py-12 md:py-20 border-y border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-700 max-w-2xl mx-auto font-medium">Herramientas diseñadas para que el negocio local facture más cada día.</p>
          </div>
      ...
      <Section className="bg-slate-50 py-12 md:py-24 overflow-hidden border-y border-slate-100">
        <div className="text-center mb-16 px-4">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto font-medium">Muchos negocios ya han confiado en nuestro sistema para digitalizar su captación de clientes.</p>
        </div>
        ...
        <div className="relative group max-w-6xl mx-auto px-4">
          <div className="absolute top-1/2 -left-4 md:-left-12 -translate-y-1/2 z-10 hidden md:block">
            <button onClick={() => scroll('left')} className="p-3 bg-white border border-slate-200 rounded-full shadow-lg text-slate-500 hover:text-blue-600 transition-all"><ChevronLeft size={24} /></button>
          </div>
          <div className="absolute top-1/2 -right-4 md:-right-12 -translate-y-1/2 z-10 hidden md:block">
            <button onClick={() => scroll('right')} className="p-3 bg-white border border-slate-200 rounded-full shadow-lg text-slate-500 hover:text-blue-600 transition-all"><ChevronRight size={24} /></button>
          </div>
          ...
          <div ref={scrollRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-8">
            {REVIEWS.map((review, i) => (
              <a 
                ...
                className="flex-shrink-0 w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] snap-start p-8 rounded-3xl bg-white border border-slate-100 flex flex-col hover:shadow-xl transition-shadow duration-300 relative"
              >
