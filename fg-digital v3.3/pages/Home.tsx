    ...
    <main>
      ...
      <Section className="bg-white py-16 md:py-32 overflow-hidden">
        <div className="text-center mb-16 px-4">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-slate-900 mb-6">Rating 5.0 en Google</h2>
          <p className="text-slate-600 max-w-2xl mx-auto text-lg leading-relaxed">Muchos negocios en la Región de Murcia ya han confiado en nuestro sistema para digitalizar su captación de clientes.</p>
        </div>
