...
import { Menu, X, ArrowRight, ShieldAlert, ChevronDown, ChevronUp, Mail, Phone, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-slate-300 mb-4 group">
              ...
              <span className="text-sm font-medium">Murcia, España</span>
            </div>
            <a href="tel:+34694285438" className="flex items-center gap-3 hover:text-white transition-colors group">
              ...
              <span className="text-sm font-medium">+34 694 28 54 38</span>
            </a>
            <a href="mailto:info@fgdigitalsystems.com" className="flex items-center gap-3 hover:text-white transition-colors group">
              ...
              <span className="text-sm font-medium">info@fgdigitalsystems.com</span>
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link to="/web-que-vende" className="hover:text-blue-400 transition-colors">Web que Vende</Link></li>
            <li><Link to="/seo-local" className="hover:text-blue-400 transition-colors">SEO Local</Link></li>
            <li><Link to="/tarifas-diseno-web" className="hover:text-blue-400 transition-colors">Tarifas Web</Link></li>
            <li><Link to="/casos-exito" className="hover:text-blue-400 transition-colors">Casos de Éxito</Link></li>
          </ul>
        </div>
        
        <div>
          <h2 className="text-white font-bold text-lg mb-4">Zonas Estratégicas</h2>
          <div className="space-y-2">
            ...
            >
              <span className="font-medium">Seleccionar Ciudad</span>
            ...
            {showZonas && (
              <ul className="pl-3 mt-2 space-y-2 border-l border-slate-700 text-xs">
                {LOCATIONS.map((loc) => (
                  <li key={loc.slug}>
                    <span className="text-slate-300 font-bold block mb-1">{loc.name}</span>
                    <div className="grid grid-cols-1 gap-1 ml-2 opacity-70">
        ...
        <div>
          <h2 className="text-white font-bold text-lg mb-4">Especialidades</h2>
          <div className="space-y-2">
            <button 
              onClick={() => setShowProfesiones(!showProfesiones)}
              className="flex items-center justify-between w-full text-left hover:text-blue-400 transition-colors group"
            >
              <span className="font-medium">SEO por sector</span>
            ...
            {showProfesiones && (
              <ul className="pl-3 mt-2 space-y-2 border-l border-slate-700 text-xs">
                {PROFESSIONS_LIST.map((prof) => (
                  <li key={prof.slug}>
                    <span className="text-slate-300 font-bold block mb-1">{prof.name}</span>
                    <div className="flex flex-wrap gap-x-2 gap-y-1 opacity-70">
