...
// Fix: Corrected import of CANONICAL_DOMAIN which is in metadata.ts, not constants.tsx
        ...
        <Section className="py-12 md:py-20">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8 px-2 md:px-0">
              ...
              <div 
                className="prose prose-blue prose-lg max-w-none text-slate-600 leading-relaxed
                  ...
                  prose-p:mb-8 prose-p:text-lg prose-p:leading-8
                  prose-strong:text-slate-900 prose-strong:font-extrabold
                  prose-blockquote:border-l-4 prose-blockquote:border-blue-600 prose-blockquote:bg-blue-50/50 
