...
export const METADATA: Record<string, PageMetadata> = {
  ...
  webQueVende: {
    title: "Diseño Web Profesional para Negocios Locales | FG Digital Systems",
    description: "Creamos webs enfocadas a la venta. Diseño mobile-first, carga ultra-rápida y textos persuasivos para convertir visitas en clientes.",
    path: "/web-que-vende",
    ogType: "website"
  },
  seoLocal: {
    title: "SEO Local y Posicionamiento en Google Maps | FG Digital Systems",
    description: "Domina las búsquedas locales en tu ciudad. Optimizamos tu ficha de Google Business y tu web para aparecer en el Top 3 de Maps.",
    path: "/seo-local",
    ogType: "website"
  },
  captacionLeads: {
    title: "Sistemas de Captación de Clientes y Leads | FG Digital Systems",
    description: "Transformamos tu web en una herramienta de captación constante con WhatsApp integrado, formularios de venta y embudos directos.",
    path: "/captacion-de-clientes",
    ogType: "website"
  },
  mantenimientoWeb: {
    title: "Mantenimiento Web y Soporte SEO Mensual | FG Digital Systems",
    description: "Delegación técnica total. Mantenemos tu web rápida, segura y siempre optimizada para que sigas creciendo en Google mes a mes.",
