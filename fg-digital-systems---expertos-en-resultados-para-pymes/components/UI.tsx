...
import { ChevronDown, CheckCircle2, ShieldCheck, ChevronRight, Home as HomeIcon } from 'lucide-react';
...
export const Section: React.FC<{
  ...
  // Optimizado: Reducido de py-10 a py-6 en móvil para mejorar la fluidez
