    ...
    <main>
      ...
      <Section className="pt-12 md:pt-32 pb-10 md:pb-16 text-center bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        ...
        <div className="max-w-4xl mx-auto mt-8">
          ...
          <p className="text-lg md:text-2xl text-blue-100 mb-10 md:mb-12 max-w-2xl mx-auto leading-relaxed">
            Hacemos que tu negocio aparezca el primero cuando tus vecinos buscan tus servicios. Sin pagar anuncios, <strong>solo visibilidad real murciana.</strong>
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
            ...
            <Button to="/precios" variant="outline" className="px-10 py-5 text-lg border-white text-white hover:bg-white/10">
              Ver Tarifas de Maps
            </Button>
          </div>
          ...
          <div className="order-1 md:order-2 bg-slate-100 p-6 md:p-12 rounded-[2rem] border border-slate-200 relative overflow-hidden group">
             ...
             <div className="space-y-4 md:space-y-6">
                <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200">
                   ...
                   <p className="text-slate-500 text-xs italic">"Tengo la ficha de Google creada, pero no me trae nada..."</p>
                </div>
      ...
      <Section className="bg-white py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm md:text-lg">Tu negocio abierto al público local en Maps.</p>
        </div>
      ...
      <Section id="packs" className="bg-slate-50 border-t border-slate-200">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-slate-600 text-sm md:text-base max-w-xl mx-auto">Selecciona cómo quieres crecer en el mapa de Murcia.</p>
        </div>
      ...
      <Section className="bg-white py-12 md:py-20 border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto">El mapa de Google es la vía más corta hacia el cliente de tu zona.</p>
          </div>
      ...
      <Section className="bg-slate-50 py-12 md:py-24">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600">Resolvemos las dudas sobre Google Maps y el mercado murciano.</p>
          </div>
