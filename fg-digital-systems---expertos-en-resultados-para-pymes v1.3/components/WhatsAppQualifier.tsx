...
const WHATSAPP_PHONE = "447865660599";
...
Cuándo: ${answers.q4}${url ? `\nMi web actual: ${url}` : ''}`;
  ...
  return (
    <>
      {/* Floating Button - Pulse effect removed as requested */}
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md transition-all duration-300">
          <div className="bg-white rounded-[2.5rem] w-full max-w-lg shadow-[0_32px_64px_-12px_rgba(0,0,0,0.3)] flex flex-col overflow-hidden border border-slate-200">
            ...
            <div className="p-6 md:p-8 flex justify-between items-center border-b border-slate-50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-black text-slate-900 tracking-tight">Presupuesto Rápido</h3>
            ...
            <div className={`flex-grow p-6 md:p-8 min-h-[360px] flex flex-col transition-opacity duration-150 ${isAnimating ? 'opacity-0' : 'opacity-100'}`}>
              ...
              {step < QUESTIONS.length ? (
                ...
                <div className="flex-grow space-y-6">
                  ...
                  <div>
                    <label className="flex items-center gap-2 font-black text-slate-800 mb-3 text-xs uppercase tracking-widest">
